...
public record BookInfoResponse(
        ...
        @Schema(description = "The book's publication year.", example = "2008")
        Year year,

        @Schema(description = "The book's edition number.", example = "1")
        Integer edition,
        ...
        @Schema(description = "The date and time when the book was last updated.", example = "2026-04-24T18:00:33")
